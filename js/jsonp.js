...
Ajax.JSONRequest = Class.create(Ajax.Base, (function() {
  ...
  return {
    ...
    // Define local vars
      ...
      // document.getElementById("searchQuery").innerHTML="searchQuery: <br/><h3>"+url+"</h3>";
...
Ajax.JSONResponse = Class.create({
  ...
  // document.getElementById("searchResult").innerHTML="searchResult: <br/><h3>"+this.responseText+"</h3>";
  },
